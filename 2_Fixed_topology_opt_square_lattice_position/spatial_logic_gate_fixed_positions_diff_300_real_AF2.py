...
def run_genetic_algorithm(network, X, Y, ndata):
    ...
    for j in range(npop):
        ...
        # iteration = 0
        while True:
            x_indices_pop_trail[0] = np.random.uniform(500, 3000)  # X index of input 1
            x_indices_pop_trail[1] = np.random.uniform(500, 3000)  # X index of input 2 
            x_indices_pop_trail[2] = np.random.uniform(2000, 10000)  # X index of hidden node 1
            x_indices_pop_trail[3] = np.random.uniform(2000, 10000)  # X index of hidden node 2

            y_indices_pop_trail[0] = np.random.uniform(500, 12000)  # Y index of input node 1
            y_indices_pop_trail[1] = np.random.uniform(500, 12000)  # Y index of input node 2
            y_indices_pop_trail[2] = np.random.uniform(2000, 12000)  # Y index of hidden node 1
            y_indices_pop_trail[3] = np.random.uniform(2000, 12000)  # Y index of hidden node 2
