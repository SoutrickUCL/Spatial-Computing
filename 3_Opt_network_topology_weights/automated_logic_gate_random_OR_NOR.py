...
import importlib
import spatial_logic_gate_QO_KY_automate_random_OR_NOR as slg
import csv
# Clear the terminal
...
for ii in range(len(logic_gates)):
    ...
    np.save(f'logic_data_output_all_logic_real_AF_minus60_0_{logic_gates[ii]}.npy', logic_data)
    np.save(f'logic_data_weights_all_logic_real_AF_minus60_0__{logic_gates[ii]}.npy', log_w)
...
plt.figure(1)
plt.savefig("Training_automate_all_logic_real_AF_minus60_0_OR_NOR.png")

plt.figure(2)
plt.savefig("Predicted_automate_all_logic_real_AF_minus60_0_OR_NOR.png")

plt.figure(3) 
plt.savefig("Output_automate_all_logic_real_AF_minus60_0_OR_NOR.png")

with open('pref_network_topology_all_logic_real_AF_minus60_0_OR_NOR.txt', 'w') as f:
