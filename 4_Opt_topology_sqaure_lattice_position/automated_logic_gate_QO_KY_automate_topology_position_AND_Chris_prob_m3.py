...
plt.figure(1)
plt.savefig("Training_automate_opt_loc_topo_AND_prob_m3.png")

plt.figure(2)
plt.savefig("Predicted_automate_opt_loc_topo_AND_prob_m3.png")

plt.figure(3) 
plt.savefig("Output_automate_predicted_opt_loc_topo_AND_prob_m3.png")

with open('pref_network_topology_predicted_opt_loc_topo_AND_prob_m3.txt', 'w') as f:
