...
import importlib
import spatial_logic_gate_QO_KY_automate_topology_position_OR_NOR_Chris_prob_max3 as slg
# Clear the termina
...
plt.figure(1)
plt.savefig("Training_automate_opt_loc_topo_OR_Prob_Prob_m3.png")

plt.figure(2)
plt.savefig("Predicted_automate_opt_loc_topo_OR_Prob_m3.png")

plt.figure(3) 
plt.savefig("Output_automate_predicted_opt_loc_topo_OR_Prob_m3.png")

with open('pref_network_topology_predicted_opt_loc_topo_OR_Prob_3.txt', 'w') as f:
